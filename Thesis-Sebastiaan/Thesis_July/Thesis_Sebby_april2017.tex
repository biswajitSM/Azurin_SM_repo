...
\caption{Left: part of an (80 x 80) $\upmu \textup{m}^{2}$ area showing the fractured border due to PES damaging the gold layer. Right: the (80 x 80) $\upmu \textup{m}^{2}$ of the glass surface near the 200nm thick gold layer. As can be seen, almost no proteins are present despite using the same molecule density.}
\label{no_prot}
\end{figure}
